...
{
  #Define each variable as a vector of "n_years" elements. 
  #n_years corresponds to the length of the simulation in years. Here: n_years = 30 years
  #Monoculture ####
  ...
  Treeless_vegetables_sowing_cost <- rep(0, n_years)
  ...
  # AF costs ####  Source: FE- farmer/practitioner estimate; EE- expert estimate
  #Implementation cost 
